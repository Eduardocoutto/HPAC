...
unidade VARCHAR(100),
logo INT NULL,
FOREIGN KEY(ID_ende) REFERENCES endereço (ID_ende) MATCH FULL ON DELETE RESTRICT ON UPDATE CASCADE
);
...
ID_pess_FK INT,
email VARCHAR(150),
FOREIGN KEY(ID_pess_FK) REFERENCES pessoa (ID_pess) MATCH FULL ON DELETE RESTRICT ON UPDATE CASCADE
);
...
ID_prod INT,
ID_pess INT,
FOREIGN KEY(ID_supe) REFERENCES supermercado (ID_supe) MATCH FULL ON DELETE RESTRICT ON UPDATE CASCADE,
FOREIGN KEY(ID_pess) REFERENCES pessoa (ID_pess) MATCH FULL ON DELETE RESTRICT ON UPDATE CASCADE,
